...
<style>
   ...
   @media print {
        ...
        body, html {
            ...
            width: 100%;
            height: auto;
            font-size: 9.5pt; /* **SLIGHTLY LARGER FONT SIZE for readability** */
        ...
        .navbar, .footer, .btn, .print-button-container, .toast-container,
        /* Specific elements from your provided HTML structure that are often part of layout/navigation */
        .container.my-5 > .row > .col-12 > h1:first-child, /* "Exam Review" title */
        .container.my-5 > .row > .col-12 > p.text-muted.mb-5, /* "A detailed review..." subtitle */
        .container.my-5 > .row > .col-12 > h2.mb-4:last-of-type /* "Question Breakdown" heading */
        {
        ...
        .row, .col-md-6, .col-12 {
            ...
            margin: 0 !important;
            padding: 0 !important;
            flex: none !important; /* Disable flex properties */
        }


        /* --- THE CORE FIX: Prevent individual question cards from breaking --- */
        .card.mb-4 { /* This targets your exact question wrapper */
            /* Force avoid breaks within the card */
            break-inside: avoid-page !important; /* This is the key property */
            page-break-inside: avoid !important;
            -webkit-column-break-inside: avoid !important;

            border: 1px solid #eee !important; /* Keep borders visible */
            box-shadow: none !important; /* Remove shadows */
            margin-bottom: 15px !important; /* **MORE MARGIN** between questions for separation */
            background-color: #fff !important; /* Ensure white background */
            position: relative; /* Sometimes helps with break-inside on children */
            overflow: hidden; /* Prevent content overflow issues with breaks */
        }
        ...
        .card-body {
            padding-top: 10px !important; /* Add space above body content */
            padding-bottom: 10px !important;
        }
        .card-footer {
            padding-top: 15px !important; /* Add space above footer content */
            border-top: 1px solid #eee !important; /* Clear separator for footer */
            margin-top: 15px !important;
        }
        .card-body p.fw-bold.fs-5 { /* Question text */
            font-size: 1em !important; /* Restore to a more readable size */
            margin-bottom: 0.8em !important; /* More space below question */
        }
        ...
        .list-group-item {
            ...
            margin-bottom: 4px !important; /* More space between options */
            background-color: transparent !important;
            color: #000 !important;
            font-size: 0.95em !important; /* Restore to a more readable size */
        }
        /* Colors for success/danger items */
        .list-group-item-success { background-color: #e6ffe6 !important; color: #000 !important; }
        .list-group-item-danger { background-color: #ffe6e6 !important; color: #000 !important; }
        .list-group-item::before { content: none !important; }
        ...
        .badge {
            ...
            border-radius: 4px;
            font-size: 0.8em !important; /* More readable font */
            display: inline-block;
        }
        .badge.bg-success { border-color: #28a745 !important; color: #28a745 !important; }
        ...
        h1, h2, h3, h4, h5, h6, p, blockquote {
            ...
            margin-top: 0.8em !important; /* More comfortable margins */
        ...
        .session-summary-card {
            ...
            margin-bottom: 30px !important; /* More margin */
        ...
        blockquote.blockquote {
            ...
            padding: 8px 15px !important; /* More padding */
            margin: 10px 0 !important;
            font-size: 0.9em !important; /* Slightly larger font */
    ...
    <?php foreach ($answers as $index => $answer): ?>
        ...
        <div class="card mb-4"> <!-- This is the target for break-inside: avoid-page -->
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Question <?= ($pagination ? $pagination->offset : 0) + $index + 1 ?></h5>
                <?php if ($isCorrect): ?>
...
<?php
// PHP code to check for the 'print' parameter in the URL
$triggerPrint = Yii::$app->request->get('print') === 'true';
echo $triggerPrint;
if ($triggerPrint) {
    $js = <<<JS
