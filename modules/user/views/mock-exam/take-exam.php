        ...
        <div class="container">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between gap-3">
                ...
                <div class="fw-bold text-center text-md-start">
                    ...
                    <div class="fw-bold text-danger small mt-1" title="You must answer these before continuing">
                        Skipped: <span class="skipped-count"><?= $skippedCount ?></span>
                    </div>
                </div>
                ...
                <!-- Timer + Tools -->
                <div class="d-flex align-items-center justify-content-center justify-content-md-end flex-shrink-0">
...
$skipUrl = Url::to(['mock-exam/skip-question']);
$answerUrl = Url::to(['mock-exam/save-answer']);
$sessionId = $session;
...
$heartbeatUrl = Url::to(['mock-exam/heartbeat']);
$js_exam_logic = <<<JS
...
$(function () {
    ...
    function updateTimer() {
        ...
        if (timeLeft <= 0) {
            ...
            clearInterval(timerInterval);
            display.addClass('text-danger fw-bold');
        }
...
$(document).ready(function() {
    const selectedAnswer = $('#question-container').data('selected-answer');
    if (selectedAnswer) {
